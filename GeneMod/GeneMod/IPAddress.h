...
public:
	IPAddressWrapper(Uint16 port); //create and associate a port to the instance
	IPAddressWrapper(std::string host, Uint16 port); //create and associate a port and a host to the instance
